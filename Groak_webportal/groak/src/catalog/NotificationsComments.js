...
export const DeleteDishesPopUpTitle = 'Delete Dishes?';
export const DeleteDishPopUp = 'Are you sure you would like to delete this dish?';
export const DeleteDishesPopUp = 'Are you sure you would like to delete these dishes?';
...
export const ErrorAddingCategories = 'Error adding menu categories';
export const ErrorUpdatingCategory = 'Error updating menu category';
export const ErrorUpdatingCategories = 'Error updating menu categories';
export const ErrorDeletingCategory = 'Error deleting menu category';
export const ErrorDeletingCategories = 'Error deleting menu categories';
...
export const CategoriesAdded = 'Categories added';
export const CategoryUpdated = 'Category updated';
export const CategoriesUpdated = 'Categories updated';
export const CategoryDeleted = 'Category deleted';
export const CategoriesDeleted = 'Categories deleted';
