...
import { updateDishAPI } from '../DishesAPICalls';
            ...
            {!state.loadingSpinner ? (
                ...
                >
                    ...
                    <TableCell style={{ display: 'flex', flexDirection: 'column' }} align="center">
                        <input
                            accept="image/*"
                            id={`icon-button-photo-${dishItem.id}`}
                            onChange={addImage}
                            type="file"
                            style={{ display: 'none' }}
                            onClick={(event) => {
                        ...
                        />
                        <label htmlFor={`icon-button-photo-${dishItem.id}`}>
                            <Button
                                variant="contained"
                    ...
                    <TableCell align="center">
                        <Checkbox
                            ...
                            checked={checked}
                            onChange={() => { addToCheckedDish(dishItem.id); }}
