...
const Tables = () => {
    ...
    useEffect(() => {
        async function fetchTables() {
            await fetchTablesAPI(globalState.restaurantIdPortal, setState, enqueueSnackbar);
        }
        fetchTables();
    ...
    const addTableHandler = async (name) => {
        ...
        await addTableAPI(globalState.restaurantIdPortal, globalState.restaurantPortal.name, newTable, newTables, setState, enqueueSnackbar);
    };
    ...
    const deleteTableHandler = async (table) => {
        ...
        await deleteTableAPI(globalState.restaurantIdPortal, table.id, setState, enqueueSnackbar);
